...
<head>
	...
	<div id="cabecera">
              ...
              <ul>
                  ...
                  <li><a href="<?php echo base_url(); ?>index.php/Welcome/contacto" style="font-size:large;padding-left: 3px;border:solid;border-color:black;border-width:2px;background-color:green;">Contacto</a></li>
									<?php
									if(!isset($_SESSION['username'])){
										?>
      ...
      <p>Para contactar con la pagina web, contactar al alumno Alexander van den Heuvel Cabeza</p>
