...
<head>
  ...
  <h1><a href="<?php echo base_url(); ?>"><h1> TiendaOnline</h2></a></h1>
	...
	<div id="cabecera">
          ...
          $vacio=0;//esta vacio
              ...
              <div  class="">
                ...
                <aside style="width:70%;float:right;">
                    ...
                    <?php echo form_open('Welcome/unomas/'.$row->Producto); ?>
              			<input type="submit" style="margin-top: 1%;padding:10px;" name="submit" value="Añadir un producto">
              		</form>
                  <?php echo form_open('Welcome/unomenos/'.$row->Producto); ?>
            			<input type="submit" style="margin-top: 1%;padding:10px;" name="submit" value="Eliminar un producto">
            		</form>
              </aside>
            </div>
                  <?php
     ...
     <input type="submit" style="margin: 5%;padding:10px;float:right;" name="submit" value="Realizar compra">
   </form>
<?php }?>
		</section>
		<footer>
